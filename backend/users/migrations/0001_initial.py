    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Админ'), ('DIRECTOR', 'Директор'), ('HEAD_TEACHER', 'Завуч'), ('AUDITOR', 'Аудитор'), ('TEACHER', 'Учитель'), ('PARENT', 'Родитель'), ('STUDENT', 'Ученик')], default='STUDENT', max_length=20)),
